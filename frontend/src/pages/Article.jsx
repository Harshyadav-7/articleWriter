            ...
            <div style={styles.container}>
                ...
                <div style={styles.articleCard}>
                    <form style={styles.form} >
                        ...
                        {iseditingTitle ? (
                            <textarea style={styles.textarea} onChange={handleHeadChange}
                                value={head}
                                type="text"
                                placeholder="Title"
                            />
                    ...
                    <div style={styles.btnRow}><button type='button' style={styles.deleteBtn} onClick={() => handleDelete(article._id)}>Delete</button>
...
const styles = {
    ...
    updateBtn: { background: 'rgba(145, 248, 113, 0.1)', border: '1px solid rgba(190, 248, 113, 0.2)', color: '#b5f871', padding: '8px 16px', borderRadius: 8, cursor: 'pointer', fontSize: 13, fontFamily: 'DM Sans, sans-serif', alignSelf: 'flex-start', marginTop: 4 },
    textarea: { background: '#1c1c26', border: '1px solid #2a2a38', borderRadius: 10, padding: '12px 16px', color: '#f0f0f8', fontSize: 15, outline: 'none', fontFamily: 'DM Sans, sans-serif' },
